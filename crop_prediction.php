...
<div class="container">
  ...
  <?php
    ...
    // Split the output into an array of crops and filter out empty values
    $crops = array_filter(array_map('trim', explode(',', $output))); // Remove empty and whitespace-only entries
    echo '<ul>';
