  ...
  <section class="py-5" id="features">
    <div class="container">
      ...
      <div class="row g-4">
        <?php
        $features = [
          ["icon" => "chart-line", "title" => "Crop Prediction", "desc" => "Get accurate Crop predictions using regional data and ML analytics.", "link" => "./crop_prediction.php"],
          ...
          ["icon" => "vial", "title" => "Soil Testing Lab", "desc" => "Analyze soil samples and get detailed nutrient reports.", "link" => "./soil_lab.php"],
          ...
          ["icon" => "sun", "title" => "Real-Time Weather", "desc" => "Displays current weather conditions to assist farmers in planning activities.", "link" => "./realtime_weather.php"],
          ["icon" => "wallet", "title" => "Financial Planner", "desc" => "Helps farmers manage budgets, track expenses, and plan investments for better financial decisions.", "link" => "./financial.php"],
          // ["icon" => "shop", "title" => "Farmer's Marketplace", "desc" => "Connects farmers directly with buyers to sell produce and agricultural goods efficiently.", "link" => "./marketplace.php"]
        ];
